...
[gist](https://github.com/jrm2k6/space-invaders-elm/blob/master/space_invaders_multi_balls.elm).
...
To conclude, I think elm and FRP provides a nice way on iterating on your code. When you have a part of your code which is correct, you can easily extend it without worrying about breaking your previous code. You can really separate the view from the model and the update implmentation. You can also create your own tricky signals (thing I don't have here).
